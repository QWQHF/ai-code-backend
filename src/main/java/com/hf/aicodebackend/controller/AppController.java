package com.hf.aicodebackend.controller;

import cn.hutool.core.bean.BeanUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;
import com.hf.aicodebackend.annotation.AuthCheck;
import com.hf.aicodebackend.common.BaseResponse;
import com.hf.aicodebackend.common.DeleteRequest;
import com.hf.aicodebackend.common.ResultUtils;
import com.hf.aicodebackend.constant.AppConstant;
import com.hf.aicodebackend.constant.UserConstant;
...
import com.hf.aicodebackend.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    public BaseResponse<Long> addApp(@RequestBody AppAddRequest appAddRequest, HttpServletRequest request) {
        ...
        ThrowUtils.throwIf(StrUtil.isBlank(initPrompt), ErrorCode.PARAMS_ERROR, "初始提示不能为空");
        // 获取当前登录用户
    ...
    public BaseResponse<Boolean> deleteAppByAdmin(DeleteRequest deleteRequest) {
        if (deleteRequest == null || deleteRequest.getId() <= 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        long id = deleteRequest.getId();
